...
class SubscriptionMissedPaymentStaffNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable): array
    {
        ...
        return [
            ...
            'message' => 'Missed payment for ' . $donorName . ' — ' . $this->subscription->displayPlanName() . ' subscription (' . number_format((float) $this->subscription->amount, 2) . ' ' . ($this->subscription->currency ?? config('services.paypal.currency', 'USD')) . ').',
