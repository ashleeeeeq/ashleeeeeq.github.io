<x-dashboardlayout name="{{ $name }}" title="Create User">
    <div class="mb-8">
        <!-- Header Section -->
                ...
                <div class="px-4 sm:px-6 py-3 sm:py-4 border-b"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs" style="color: rgba(255,255,255,0.5);">Configure staff role, department,
                                and position</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="relative">
                                <select name="role"
                                    ...
                                    <option value=""
                                        ...
                                        disabled selected>Select role</option>
                                    @foreach ($roles as $roleValue => $roleLabel)
                                        <option value="{{ $roleValue }}"
                                            style="color: var(--color-primary1); background-color: var(--color-white);"
                                            @selected(old('role') === $roleValue)>{{ $roleLabel }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="department_id"
                                        ...
                                        <option value=""
                                            style="color: var(--color-primary1); background-color: var(--color-white);"
                                            disabled selected>Select department</option>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="position_id"
                                        ...
                                        <option value=""
                                            style="color: var(--color-primary1); background-color: var(--color-white);"
                                            disabled selected>Select position</option>
                                        @foreach ($positions as $position)
                                            <option value="{{ $position->id }}"
                                                style="color: var(--color-primary1); background-color: var(--color-white);"
                                                @selected((string) old('position_id') === (string) $position->id)>{{ $position->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                        <svg class="w-4 h-4 transition-colors duration-200"
                ...
                <div class="px-4 sm:px-6 py-3 sm:py-4 border-b"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs" style="color: rgba(255,255,255,0.5);">Enter the staff member's personal
                                details</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-4 sm:px-6 py-3 sm:py-4 border-b"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs" style="color: rgba(255,255,255,0.5);">Enter the staff member's contact
                                details</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="address_line"
                                class="w-full px-4 py-2.5 text-primary1 rounded-xl border focus:outline-none focus:ring-2 focus:ring-accent1 focus:border-accent1 transition-all duration-200 hover:border-accent1"
                                style="font-family: var(--font-body1); background-color: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.15);"
                                value="{{ old('address_line') }}" placeholder="Enter street address" required>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="province"
                                    class="w-full px-4 py-2.5 text-primary1 rounded-xl border focus:outline-none focus:ring-2 focus:ring-accent1 focus:border-accent1 transition-all duration-200 hover:border-accent1"
                                    style="font-family: var(--font-body1); background-color: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.15);"
                                    value="{{ old('province') }}" placeholder="Enter state/province" required>
                ...
                <div class="px-4 sm:px-6 py-3 sm:py-4 border-b"
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs" style="color: rgba(255,255,255,0.5);">The staff member will receive
                                login instructions via email</p>
                        </div>
                    </div>
                </div>
                <div class="p-4 sm:p-6">
