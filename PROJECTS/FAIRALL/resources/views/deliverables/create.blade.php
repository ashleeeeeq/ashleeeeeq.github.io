@php
    ...
    $storeRoute = $isDonor
        ? route('donors.deliverables.store', $owner)
        : route('grants.deliverables.store', $owner);
@endphp

<x-dashboardlayout name="{{ $name }}" title="Create Deliverable">
    <div class="mb-8 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                ...
                <h1 class="text-2xl md:text-3xl font-bold tracking-tight" style="font-family: var(--font-header1); color: var(--color-white);">Create Deliverable</h1>
                <p class="text-sm mt-1" style="color: rgba(255,255,255,0.6); font-family: var(--font-body1);">Set a task window for {{ $ownerName }}</p>
            ...
            <div class="rounded-2xl overflow-hidden" style="background-color: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08);">
                <div class="px-6 py-4 border-b" style="border-color: rgba(255,255,255,0.08); background: linear-gradient(135deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.02) 100%);">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs mt-0.5" style="color: rgba(255,255,255,0.5);">Fill in the details below</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        ...
                        <div>
                            <label class="block mb-2 text-xs font-semibold uppercase tracking-wider" style="color: rgba(255,255,255,0.5); font-family: var(--font-body1);">End Date <span class="text-xs font-normal" style="color: var(--color-danger);">*</span></label>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" 
                                  ...
                                  placeholder="Enter deliverable description...">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
