...
<x-layout title="Sign Up as Organization Donor">
    <div class="min-h-screen max-h-screen w-full relative flex items-center justify-center py-5 px-4 md:px-6">
        <!-- Main Container -->
            ...
            <div class="flex flex-col md:flex-row rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div class="hidden md:block md:w-2/5 relative overflow-hidden">
                    ...
                    <div class="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                        ...
                        <h2 class="text-3xl font-bold mb-3 text-white" style="font-family: var(--font-header1);">Partner
                            With Us</h2>
                    ...
                    <div class="w-full">
                        ...
                        <div class="text-center mb-6 md:hidden">
                            ...
                            <h2 class="text-2xl font-bold"
                                style="font-family: var(--font-header1); color: var(--color-primary1);">Organization
                                Donor
                            </h2>
                        ...
                        <div class="text-center mb-6 hidden md:block">
                            ...
                            <div class="w-12 h-0.5 mx-auto mt-2 rounded-full"
                                style="background-color: var(--color-accent1);"></div>
                            <p class="text-gray-500 mt-2 text-sm" style="font-family: var(--font-body1);">Partner with
                                us to make a greater impact</p>
                        </div>

                        <form method="POST" action="/register" class="space-y-4">
                            @csrf
                            <input type="hidden" name="donor_type" value="organization">

                            <!-- Organization Name -->
                            <div>
                                <label class="block mb-2 text-sm font-semibold"
                                    style="font-family: var(--font-body1); color: var(--color-primary1);">Organization
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email"
                                        class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-yellow-400/50 transition-all"
                                        style="font-family: var(--font-body1); background-color: #f9fafb; color: var(--color-primary1);"
                                        placeholder="contact@organization.com" value="{{ old('email') }}" required>
