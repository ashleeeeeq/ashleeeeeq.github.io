<x-dashboardlayout name="{{ $name }}" title="Create Grant">
    <div class="mb-8 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-sm mt-1" style="color: rgba(255,255,255,0.6); font-family: var(--font-body1);">
                    Create a standalone grant with contact information
                </p>
        ...
        <!-- Form -->
        <form method="POST" action="/grants" class="space-y-6">
            @csrf

            @include('grants._form', ['grant' => null, 'programs' => $programs])
