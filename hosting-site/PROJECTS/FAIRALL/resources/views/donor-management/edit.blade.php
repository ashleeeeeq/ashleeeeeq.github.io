<x-dashboardlayout name="{{ $name }}" title="Edit Donor">
    <div class="mb-8 space-y-6">
        <!-- Header Section -->
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold tracking-tight"
                    style="font-family: var(--font-header1); color: var(--color-white);">Edit Donor</h1>
                <p class="text-sm mt-1" style="color: rgba(255,255,255,0.6); font-family: var(--font-body1);">Update donor
                    profile and contact details</p>
        ...
        <form method="POST" action="{{ route('donors.update', $donor) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="rounded-2xl overflow-hidden"
                ...
                <div class="p-6 space-y-5">
                    <!-- Row 1: Donor Type (Full Width) -->
                    <div>
                        <label class="block mb-2 text-xs font-semibold uppercase tracking-wider"
                            style="color: rgba(255,255,255,0.5); font-family: var(--font-body1);">Donor Type <span
                        ...
                        <div class="relative">
                            <select name="donor_type" id="donor_type"
                                ...
                                <option value="individual"
                                    style="background-color: var(--color-white); color: var(--color-primary1);"
                                    @if (old('donor_type', $donor->donor_type) == 'individual') selected @endif>Individual</option>
                                <option value="organization"
                                    style="background-color: var(--color-white); color: var(--color-primary1);"
                                    @if (old('donor_type', $donor->donor_type) == 'organization') selected @endif>Organization</option>
                            </select>
                    ...
                    <div id="individual-fields" class="grid gap-5 md:grid-cols-3">
                        <div>
                            ...
                            <input type="text" name="first_name"
                                ...
                                value="{{ old('first_name', $donor->first_name) }}" placeholder="Enter first name">
                        ...
                        <div>
                            ...
                            <input type="text" name="middle_name"
                                class="w-full rounded-xl px-4 py-2.5 text-primary1 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent1"
                                style="font-family: var(--font-body1); background-color: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);"
                                value="{{ old('middle_name', $donor->middle_name) }}" placeholder="Enter middle name">
                        ...
                        <div>
                            ...
                            <input type="text" name="last_name"
                                class="w-full rounded-xl px-4 py-2.5 text-primary1 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent1"
                                style="font-family: var(--font-body1); background-color: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);"
                                value="{{ old('last_name', $donor->last_name) }}" placeholder="Enter last name">
                    ...
                    <div class="grid gap-5 md:grid-cols-2">
                        <div>
                            ...
                            <input type="email" name="email"
                                class="w-full rounded-xl px-4 py-2.5 text-primary1 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent1"
                                style="font-family: var(--font-body1); background-color: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);"
                                value="{{ old('email', $donor->user?->email) }}" placeholder="Enter email address"
                                required>
                        ...
                        <div>
                            ...
                            <x-forms.phone-input name="contact_number"
                                value="{{ old('contact_number', $donor->contact_number) }}" :required="true" />
                        </div>
                    </div>


                    <!-- Row 4: Organization Field (Hidden by default) -->
                    <div id="organization-fields" class="hidden">
                        ...
                        <input type="text" name="organization_name"
                            class="w-full rounded-xl px-4 py-2.5 text-primary1 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent1"
                            style="font-family: var(--font-body1); background-color: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);"
                            value="{{ old('organization_name', $donor->organization_name) }}"
            ...
            <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4">
                <a href="{{ route('donors.index', $donor) }}"
