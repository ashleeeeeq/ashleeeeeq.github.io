<x-dashboardlayout name="{{ $name }}" title="Edit Education Intake">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-white/60 text-sm mt-1" style="font-family: var(--font-body1);">Beneficiary: <span
                        class="font-semibold text-white/80">{{ $beneficiary->display_name }}</span></p>
        ...
        <form method="POST" action="/beneficiaries/{{ $beneficiary->id }}/education-intake">
            ...
            <div class="flex justify-between gap-3 pt-6 mt-6 border-t" style="border-color: rgba(255,255,255,0.1);">
                <a href="/beneficiaries/{{ $beneficiary->id }}/profile"
                    class="px-6 py-2.5 font-semibold rounded-xl transition-all duration-300 hover:scale-[1.02] text-center inline-flex items-center gap-2 group"
