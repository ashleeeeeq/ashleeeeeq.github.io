<x-dashboardlayout name="{{ $name }}" title="Schedule Home Visit">
    <div class="mb-8 space-y-6">
        <!-- Header Section -->
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold tracking-tight" style="font-family: var(--font-header1); color: var(--color-white);">Schedule Home Visit</h1>
                <p class="text-sm mt-1" style="color: rgba(255,255,255,0.6); font-family: var(--font-body1);">Create a new home visit record for a beneficiary</p>
        ...
        <form method="POST" action="{{ route('home-visits.store') }}" class="space-y-6">
            @csrf
